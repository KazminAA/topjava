        ...
        <table class="table table-striped display" id="datatable">
            ...
            <c:forEach items="${meals}" var="meal">
                ...
                <tr class="${meal.exceed ? 'exceeded' : 'normal'}">
                    ...
                    <td><a class="delete" id=${meal.id}><span class="glyphicon glyphicon-remove"></span> </a></td>
                </tr>
            </c:forEach>
        </table>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="detailsForm">
                    ...
                    <div class="form-group">
                        <label for="dateTime" class="control-label col-sm-3"><spring:message
                    ...
                    <div class="form-group">
                        <label for="description" class="control-label col-sm-3"><spring:message
                    ...
                    <div class="form-group">
                        <label for="calories" class="control-label col-sm-3"><spring:message
